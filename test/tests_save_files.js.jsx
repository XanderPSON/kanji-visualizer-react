var Kanji = React.createClass( {
    ...
    render: function() {
        return (
          <button className={this.state.currentClass} onClick={this.props.onClick}>
...
var NoLevelFrame = React.createClass({
  ...
  render: function() {
    var allKanjiButtons = this.props.noLevelKanjis.map(function(kanji, i){
      return (<Kanji key={i} index={i} character={kanji} onClick={this.clickKanji} />);
    });
    return (
...
var KanjiSheet = React.createClass({
  getInitialState: function() {
    ...
    return {
            ...
            firstLevelKanjis: allKanji,
            secondLevelKanjis: allKanji,
            thirdLevelKanjis: allKanji,
            fourthLevelKanjis: allKanji,
            counter: 0
            };
  },
  clickKanji: function(clickedKanji) {
  ...
  render: function() {
    ...
    return (
      <div id="kanjiSheet">
        <h2>My Kanji</h2>
        {this.state.counter}
        <button onClick={this.clickKanji.bind(null, "Nemo")}>Touch me</button>
        <hr />
        <div className="clearfix">
          <NoLevelFrame noLevelKanjis={this.state.noLevelKanjis} />
          <FirstLevelFrame firstLevelKanjis={this.state.firstLevelKanjis} />
          <SecondLevelFrame secondLevelKanjis={this.state.secondLevelKanjis} />
          <ThirdLevelFrame thirdLevelKanjis={this.state.thirdLevelKanjis} />
          <FourthLevelFrame fourthLevelKanjis={this.state.fourthLevelKanjis} />
        </div>
        <div>
          {allKanjiButtons}
        </div>
...
var Kanji = React.createClass( {
    ...
    render: function() {
        return (
          <button className={this.state.currentClass} onClick={this.update}>
            {this.props.character}
          </button>
          );
    }
...
var KanjiSheet = React.createClass({
  ...
  clickKanji: function(clickedKanji) {
    this.setState({noLevelKanjis: this.state.allKanjis.push(clickedKanji)})
  },
  render: function() {
    var allKanjiButtons = this.state.allKanjis.map(function(kanji, i){
      return (<Kanji key={i} index={i} character={kanji} onClick={this.clickKanji} />);
    ...
    return (
      <div id="kanjiSheet">
        <h2>My Kanji</h2>
        <button onClick={this.clickKanji}>Touch me</button>
        <hr />
        <div className="clearfix">
          <NoLevelFrame noLevelKanjis={this.state.noLevelKanjis} />
          <FirstLevelFrame firstLevelKanjis={this.state.firstLevelKanjis} />
